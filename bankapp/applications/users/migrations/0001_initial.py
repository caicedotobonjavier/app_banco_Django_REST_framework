    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activation_code', models.CharField(blank=True, max_length=6, null=True, verbose_name='Codigo de activacion')),
                ('otp_base32', models.CharField(blank=True, max_length=255, null=True, verbose_name='OTP 32')),
                ('login_otp', models.CharField(blank=True, max_length=255, null=True, verbose_name='OTP Login')),
                ('user_login_otp', models.BooleanField(default=False, verbose_name='Login Usado')),
